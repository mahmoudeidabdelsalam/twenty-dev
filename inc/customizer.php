 ...
 * @return void
 */
function twenty_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'twenty' ),
				'description' => __( 'Height: &gt;80px', 'twenty' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'twenty' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'twenty' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'twenty' ),
				'navbar-dark bg-primary' => __( 'Primary', 'twenty' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'twenty' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'twenty' ),
				'fixed_top'    => __( 'Fixed to top', 'twenty' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'twenty' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'twenty' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'twenty_customize' );
