...
<div id="wrapper">
	<header>
        ...
        <div class="top-bar-mobile d-lg-none d-md-none d-flex justify-content-between align-items-center w-100">
          ...
          <a class="btn btn-primary py-3 px-2 text-white rounded-0 d-none" href="<?= $page_car_hraj; ?>">سيارات مفحوصة مضمونة</a>
          <a class="btn bg-blue py-3 px-2 text-white rounded-0 d-none" href="<?= $page_car_used; ?>">حراج السيارات المستعملة</a>
        </div>
        <!-- menu topbar dasktop-->
